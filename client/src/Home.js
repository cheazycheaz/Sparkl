...
function Home() {
  const { login, logout, isAuthenticated } = usePrivy();
  ...
  return (
    <div className="max-w-7xl mx-auto p-4">
      {isAuthenticated ? (
        ...
        <button onClick={login} className="mt-4 px-4 py-2 bg-green-500 text-white rounded">Login</button>
      )}
      <div className="mt-8 p-4 bg-white rounded-xl shadow">
        ...
        ></textarea>
        <button className="mt-2 px-4 py-2 bg-primary text-white rounded-full">Post</button>
      </div>
